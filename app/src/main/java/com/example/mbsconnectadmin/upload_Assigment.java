...
public class upload_Assigment extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if(pdfdata==null)
                {
                    ...
                    StyleableToast.makeText(upload_Assigment.this,"Please choose a assigment!!!",R.style.failure).show();
                }
                else
                {
    ...
    private void uploadpdf() {
        StorageReference reference=storageReference.child("assigment/"+pdfName+"-"+System.currentTimeMillis()+".pdf");
        reference.putFile(pdfdata).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                StyleableToast.makeText(upload_Assigment.this, "Error! "+e+"!!",R.style.failure).show();
            }
        });
    }
    ...
    private void uploadData(String downloadUrl) {
        String unqiuekey=databaseReference.child("assigment").push().getKey();
        ...
        databaseReference.child("result").child(unqiuekey).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                progressBar.setVisibility(View.GONE);
                StyleableToast.makeText(upload_Assigment.this, "Assigment Uploaded!!", R.style.success).show();
                title.setText("");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==REQ && resultCode==RESULT_OK)
        {
            ...
            if(pdfdata.toString().startsWith("content://"))
            {
                Cursor cursor=null;
                try {
                    cursor=upload_Assigment.this.getContentResolver().query(pdfdata, null, null, null, null);
            ...
            StyleableToast.makeText(upload_Assigment.this,""+pdfName,R.style.info).show();
        }
    }
