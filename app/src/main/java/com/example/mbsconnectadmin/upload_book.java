...
public class upload_book extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if(pdfdata==null)
                {
                    ...
                    StyleableToast.makeText(upload_book.this,"Please choose a book!!!",R.style.failure).show();
                }
                else
                {
    ...
    private void uploadpdf() {
        ...
        reference.putFile(pdfdata).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                StyleableToast.makeText(upload_book.this, "Error! "+e+"!!",R.style.failure).show();
            }
        });
    }
    ...
    private void uploadData(String downloadUrl) {
        ...
        databaseReference.child("pdf").child(unqiuekey).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressBar.setVisibility(View.GONE);
                StyleableToast.makeText(upload_book.this, "Book Uploaded!!", R.style.success).show();
                title.setText("");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==REQ && resultCode==RESULT_OK)
        {
            ...
            if(pdfdata.toString().startsWith("content://"))
            {
                Cursor cursor=null;
                try {
                    cursor=upload_book.this.getContentResolver().query(pdfdata, null, null, null, null);
            ...
            StyleableToast.makeText(upload_book.this,""+pdfName,R.style.info).show();
    }}
