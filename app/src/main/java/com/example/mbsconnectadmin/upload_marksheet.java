...
public class upload_marksheet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_marksheet);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if(pdfdata==null)
                {
                    ...
                    StyleableToast.makeText(upload_marksheet.this,"Please choose a result!!!",R.style.failure).show();
                }
                else
                {
    ...
    private void uploadpdf() {
        ...
        reference.putFile(pdfdata).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                StyleableToast.makeText(upload_marksheet.this, "Error! "+e+"!!",R.style.failure).show();
            }
        });
    }
    ...
    private void uploadData(String downloadUrl) {
        ...
        databaseReference.child("result").child(unqiuekey).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                progressBar.setVisibility(View.GONE);
                StyleableToast.makeText(upload_marksheet.this, "Result Uploaded!!", R.style.success).show();
                title.setText("");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==REQ && resultCode==RESULT_OK)
        {
            ...
            if(pdfdata.toString().startsWith("content://"))
            {
                Cursor cursor=null;
                try {
                    cursor=upload_marksheet.this.getContentResolver().query(pdfdata, null, null, null, null);
            ...
            StyleableToast.makeText(upload_marksheet.this,""+pdfName,R.style.info).show();
        }
    }
